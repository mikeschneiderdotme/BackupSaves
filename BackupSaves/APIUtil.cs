...
namespace BackupSaves
{
    public class APIUtil
    {
        ...
        public static async Task<Dictionary<int, string>> GetSteamApps()
        {
            ...
            Dictionary<int, string> appDict = new Dictionary<int, string>();

            foreach (Game a in obj.response.games)
            {
                appDict.Add(a.appid, a.name);
            }
